    ...
    >
      ...
      <header className={classnames("hero hero--primary", styles.heroBanner)}>
        <div className="container container--fluid">
          <div className="row mt-2" style={{paddingTop: "120px", paddingBottom: "120px"}}>
            <div className="col col--8 font_large" style={{paddingLeft: "240px", paddingRight: "120px"}}>
              <div className="pl-4">
                <h1 className="hero__title text--left text--white">{siteConfig.title}</h1>
            ...
            <div className="col col--4">
              <div className={styles.buttons}>
                <Link
                  ...
                  to={useBaseUrl("https://identity.amphoradata.com/Account/Login")}
                >
                  Login
                </Link>
              </div>
      ...
      <main>
        <div className={classnames("p-4", styles.presentationContainer)}>
          <div className="container container--fluid">
            <div className={classnames("row", styles.spaceBetween)} style={{ paddingTop: "120px", paddingBottom: "60px", paddingLeft: "240px", paddingRight: "240px" }}>
              <div>
                <h2 className="font_extra_large text--left text--black">With Amphora you can</h2>
                <div className="d-flex">
                  ...
                  >
                    <span className="font_extra_large text--black">Access third-party data&nbsp;&nbsp;</span> 
                  </Link>
                </div>
                <div className="d-flex">
                  <FontAwesomeIcon
                  ...
                  >
                    <span className="font_extra_large text--black">Simplify external integration&nbsp;&nbsp;</span> 
                  </Link>
                </div>
                <div className="d-flex">
                  <FontAwesomeIcon
                  ...
                  >
                    <span className="font_extra_large  text--black">Share your data&nbsp;&nbsp;</span> 
                  </Link>
                </div>
                <div className="d-flex">
                  <FontAwesomeIcon
        ...
        <div className={classnames(styles.heroBanner)}>
          <div className={classnames("p-4", styles.opacityContainer)}>
            <h2 className="font_large">
              Amphora Data connects the worls real-time information in a single platform for any user
            </h2>
            <div className="container container--fluid">
              <img src="img/amphora_home_page.png" alt="leadership team" width="1000"/>
            </div>
          </div>
        </div>
