          ...
          <div className="col col--9">
            ...
            <div className={classnames("row mt-4", styles.spaceEvenly)}>
              <div className={styles.buttons_tab}>
                <Link className="font_medium_bold text--black" to="find-data">
                  Vegetation
                </Link>
              </div>
              <div className={styles.buttons_tab}>
...
const features = [
  {
    ...
    description: (
      <>
        <span>
          Tracking of performance through 0.5M resolution NDVI images. Options
          include ranking of plants, tracking change in performance between
          image captures and overall crop performance.
        </span>
        <span>
          Available now for any global location upon request from $0.7 per Ha
          per month.
        </span>
      </>
    ),
