...
const features = [
  {
    ...
    description: (
      <>
        Each data container has standardised, transparent metadata including quality, location, source, accuracy e.t.c. Know the full story of the data you are using.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Understand the performance and failures of your models and ETL jobs. Our workbench incorporates mlflow so you only need to use a single tool to track your models and jobs.
      </>
    ),
  },
  {
